...
#Bygs_SalesBygs_CareVerizonSkyServiceSKY_PlatformClassicLMVMCareVM Cable Care
#AT&TPhase3_GenDTVSalesAT&TPhase3_GenHSCLGAT&TPhase3_GENHSSALESAT&TPhase4_DMDR
#AT&TPhase4_ISMCLGAT&TPhase4_ISMSVCAT&TPhase4_MobCLGAT&TPhase4_MobSSNurseLineHouseCallsUHG_M&R
...
uhg = pd.read_excel('Test.xlsx', index_col=0, header=0, sheet_name='UHG_M&R')
vmtelesales = pd.read_excel('Test.xlsx', index_col=0, header=0, sheet_name='VM Telesales')
wb = Workbook()
...
def get_factors(df, name):
    ...
    for i in a:
        ...
        AI_OPPORTUNITY = 100-(Actual_Values['FAILROUTEPERC']+Actual_Values['ONAGENTSLA']+Actual_Values['ONCALLSLA']+Actual_Values['1-1CALLSWITHOUTSLABLOWNS']+Actual_Values['ONEVALUATIONERRCALLS']+Actual_Values['LOOKUPFAILURES']+Actual_Values['UNKNOWNAGENTCALLS']+Actual_Values['CGNOTFOUNDCALLS'])
        data1 = pd.DataFrame(Actual_Values.items())
        data2 = pd.DataFrame([['EBP_UPTIME', 'GAIN_ACHIEVEMENT', 'REVENUE_ACHIEVEMENT', 'One_One_Calls_Actual', 'One_One_Calls_Impact', 'Unknown_Agent_Calls_Actual', 'Unknown_Agent_Calls_Impact','AI_OPPORTUNITY'], [EBP_UPTIME, GAIN_ACHIEVEMENT, REVENUE_ACHIEVEMENT, One_One_Calls_Actual, One_One_Calls_Impact, Unknown_Agent_Calls_Actual, Unknown_Agent_Calls_Impact,AI_OPPORTUNITY]])
        ...
        if name == 'Bygs_Sales':
            ...
            data1.to_excel(writer, sheet_name='Verizon_Calculations')
            writer.save()
            writer.close()        
...
def get_factorsHouseCalls(df, name):
    ...
    a = [
     ...
     'CGNOTFOUNDCALLS%AGE', 'H/CISSUES']
    Actual_Values = {}
    for i in a:#'AGENTCHOICE''CALLCHOICE''ONEVALSCORERAW'
        Actual_Values[i] = round(sum(df[i]) * 100 / Oncall, 2)
    else:
        One_One_Calls_Actual = Actual_Values['1-1CALLS']
        One_One_Calls_Impact = round(df.iloc[0]['1-1CALLSIMPACT'] * 100, 2)
...
def get_factorsNurseLine(df, name):
    ...
    a = [
     ...
     'ONCALLSLA', 'ONCALLSLA%AGE', '1-1CALLS', '1-1CALLS%AGE',
     '1-1CALLSWITHOUTSLABLOWNS', '1-1CALLS%AGEWITHOUTSLABLOWNS', 'L2CALLS',
     'L2CALLS%AGE', 'OFFABANDONS', 'O0BANDONSPERC',
     'OFFABANDONSPERC', 'ON/OFFABANDONDIFF', 'OFFAP', 'APSKEW',
     'ONCP', 'OFFCP', 'AGENTCHOICE', 'USEDAGENTCHOICE',
     'USEDAGENTCHOICEWITHOUTSLABLOWNS', 'CALLCHOICE', 'USEDCALLCHOICE',
     'USEDCALLCHOICEWITHOUTSLABLOWNS', 'ONEVALSCORERAW', 'OFFEVALSCORERAW',
     'ONEVALSCOREUSED', 'OFFEVALSCOREUSED', 'ONEVALUATIONERRCALLS',
...
def get_factorsUHG(df, name):
    ...
    for i in a:
        ...
        data2 = pd.DataFrame([['EBP_UPTIME', 'GAIN_ACHIEVEMENT', 'REVENUE_ACHIEVEMENT', 'One_One_Calls_Actual', 'One_One_Calls_Impact', 'Unknown_Agent_Calls_Actual', 'Unknown_Agent_Calls_Impact','AI_OPPORTUNITY'], [EBP_UPTIME, GAIN_ACHIEVEMENT, REVENUE_ACHIEVEMENT, One_One_Calls_Actual, One_One_Calls_Impact, Unknown_Agent_Calls_Actual, Unknown_Agent_Calls_Impact,AI_OPPORTUNITY]])
        data1 = data1.append(data2)
        data1.to_excel(writer, sheet_name='UHG_M&R_Calculations')
        writer.save()
        writer.close()

def get_factorsVMTelesales(df, name):
    writer = pd.ExcelWriter('Test.xlsx', engine='openpyxl', mode='a')
    EBP_UPTIME = round(mean(df['UPTIMEPERCENTAGE'] * 100), 2)
    GAIN_ACHIEVEMENT = round(df['GAINACHIEVEMENT'] * 100, 2)
    GAIN_ACHIEVEMENT = GAIN_ACHIEVEMENT[1]
    ...
    for i in a:
        ...
        data2 = pd.DataFrame([['EBP_UPTIME', 'GAIN_ACHIEVEMENT', 'REVENUE_ACHIEVEMENT', 'One_One_Calls_Actual', 'One_One_Calls_Impact', 'Unknown_Agent_Calls_Actual', 'Unknown_Agent_Calls_Impact','AI_OPPORTUNITY'], [EBP_UPTIME, GAIN_ACHIEVEMENT, REVENUE_ACHIEVEMENT, One_One_Calls_Actual, One_One_Calls_Impact, Unknown_Agent_Calls_Actual, Unknown_Agent_Calls_Impact,AI_OPPORTUNITY]])
        data1 = data1.append(data2)
        data1.to_excel(writer, sheet_name='VM_Telesales_Calculations')
        writer.save()
        writer.close()
...
def insert_record(text, e, g, sched):
    ...
    if text == 'Bygs_Sales':
        ...
        sales.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        care.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        Verizon.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        messagebox.showinfo('Data Saved', 'Calculations Added to File')
    elif text == 'VM Telesales':
        vmtelesales = pd.read_excel('Test.xlsx', index_col=0, header=0, sheet_name='VM Telesales')
        vmtelesales.columns = map(lambda x: str(x).upper(), vmtelesales.columns)
        vmtelesales.columns = map(lambda x: str(x).replace('_', ''), vmtelesales.columns)
        vmtelesales.columns = map(lambda x: str(x).replace(' ', ''), vmtelesales.columns)
        Verizon.columns = map(lambda x: str(x).rstrip(), Verizon.columns)
        vmtelesales.insert(3, 'EXPECTGAIN', e)
        vmtelesales.insert(4, 'GAIN', g)
        summ = Verizon.sum(axis=0)
        vmtelesales.insert(5, 'GAINACHIEVEMENT', round(vmtelesales['GAIN'] / vmtelesales['EXPECTGAIN'] * 100, 2))
        vmtelesales.insert(9, 'SCHEDULEDTIME', sched)
        sc = vmtelesales['SCHEDULEDTIME']
        vmtelesales['DOWNTIMEINMINS'] = pd.to_numeric((vmtelesales['DOWNTIMEINMINS']), errors='coerce').fillna(0)
        dm = vmtelesales['DOWNTIMEINMINS']
        a = sc - dm
        vmtelesales.insert(10, 'UPTIMEPERCENTAGE', (a / sc).tolist())
        EBP_UPTIME = round(mean(vmtelesales['UPTIMEPERCENTAGE'] * 100), 2)
        vmtelesales.insert(6, 'REVENUEACHIEVEMENT', round(vmtelesales['GAINACHIEVEMENT'] * EBP_UPTIME / 100, 2))
        vmtelesales.insert(12, 'FAILEDROUTEIMPACT', summ['FAILROUTEPERC'] * 100 / summ['REVENUEIMPACT'])
        vmtelesales.insert(13, 'ONAGENTSLAIMPACT', summ['ONAGENTSLA%AGE'] * 100 / summ['REVENUEIMPACT'])
        vmtelesales.insert(14, 'ONCALLSLAIMPACT', summ['ONCALLSLA%AGE'] * 100 / summ['REVENUEIMPACT'])
        vmtelesales.insert(15, '1-1CALLSIMPACT', summ['1-1CALLS%AGEWITHOUTSLABLOWNS'] * 100 / summ['REVENUEIMPACT'])
        vmtelesales.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        vmtelesales.insert(17, 'LOOKUPFAILUREIMPACT', summ['LOOKUPFAILUREPERC'] * 100 / summ['REVENUEIMPACT'])
        vmtelesales.insert(18, 'UNKNOWNAGENTIMPACT', summ['UNKNOWNAGENTCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        vmtelesales.insert(19, 'CGNOTFOUNDIMPACT', summ['CGNOTFOUNDCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        write_excel('Test.xlsx', text, vmtelesales)
        get_factorsVMTelesales(Verizon, 'VM Telesales')
        messagebox.showinfo('Data Saved', 'Calculations Added to File')
        ...
        skyservice.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        sky.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        LM.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        vmcare.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        vmcablecare.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        phase3_gendtvsales.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        phase3_gendhsclg.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        phase3_gendhssales.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        phase4_dmdr.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        phase4_ismclg.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        phase4_ismsvc.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        phase4_mobclg.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        phase4_mobss.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        nurseline.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        housecalls.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        ...
        uhg = pd.read_excel('Test.xlsx', index_col=0, header=0, sheet_name='UHG_M&R')
        uhg.columns = map(lambda x: str(x).upper(), uhg.columns)
        uhg.columns = map(lambda x: str(x).replace('_', ''), uhg.columns)
        uhg.columns = map(lambda x: str(x).replace(' ', ''), uhg.columns)
        uhg.columns = map(lambda x: str(x).rstrip(), uhg.columns)
        uhg.insert(3, 'EXPECTGAIN', e)
        uhg.insert(4, 'GAIN', g)
        summ = uhg.sum(axis=0)
        uhg.insert(5, 'GAINACHIEVEMENT', round(uhg['GAIN'] / uhg['EXPECTGAIN'] * 100, 2))
        uhg.insert(9, 'SCHEDULEDTIME', sched)
        sc = uhg['SCHEDULEDTIME']
        uhg['DOWNTIMEINMINS'] = pd.to_numeric((uhg['DOWNTIMEINMINS']), errors='coerce').fillna(0)
        dm = uhg['DOWNTIMEINMINS']
        a = sc - dm
        uhg.insert(10, 'UPTIMEPERCENTAGE', (a / sc).tolist())
        EBP_UPTIME = round(mean(uhg['UPTIMEPERCENTAGE'] * 100), 2)
        uhg.insert(6, 'REVENUEACHIEVEMENT', round(uhg['GAINACHIEVEMENT'] * EBP_UPTIME / 100, 2))
        uhg.insert(12, 'FAILEDROUTEIMPACT', summ['FAILROUTEPERC'] * 100 / summ['REVENUEIMPACT'])
        uhg.insert(13, 'ONAGENTSLAIMPACT', summ['ONAGENTSLA%AGE'] * 100 / summ['REVENUEIMPACT'])
        uhg.insert(14, 'ONCALLSLAIMPACT', summ['ONCALLSLA%AGE'] * 100 / summ['REVENUEIMPACT'])
        uhg.insert(15, '1-1CALLSIMPACT', summ['1-1CALLS%AGEWITHOUTSLABLOWNS'] * 100 / summ['REVENUEIMPACT'])
        uhg.insert(16, 'ONEVALUATIONERRIMPACT', summ['ONEVALUATIONERRCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        uhg.insert(17, 'LOOKUPFAILUREIMPACT', summ['LOOKUPFAILUREPERC'] * 100 / summ['REVENUEIMPACT'])
        uhg.insert(18, 'UNKNOWNAGENTIMPACT', summ['UNKNOWNAGENTCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        uhg.insert(19, 'CGNOTFOUNDIMPACT', summ['CGNOTFOUNDCALLS%AGE'] * 100 / summ['REVENUEIMPACT'])
        write_excel('Test.xlsx', text, uhg)
        get_factorsUHG(uhg, 'UHG_M&R')
        messagebox.showinfo('Data Saved', 'Calculations Added to File')
...
def runFile(filename):
    ...
    sheet31 = wb['UHG M&R Service Genesys']
    sheet32 = wb2['UHG_M&R']
    sheet33 = wb['VMediaMan']
    sheet34 = wb2['VM Telesales']
    for i in range(1, sheet1.max_row + 1):
        ...
        for i in range(1, sheet2.max_row + 1):
            ...
            for i in range(1, sheet33.max_row + 1):
                for j in range(1, sheet33.max_column + 1):
                    sheet34.cell(row=i, column=j).value = sheet33.cell(row=i, column=j).value
            else:
                                    ...
                                    for i in range(1, sheet6.max_row + 1):
                                        ...
                                        for i in range(1, sheet7.max_row + 1):
                                            ...
                                            for i in range(1, sheet8.max_row + 1):
                                                ...
                                                for i in range(1, sheet31.max_row + 1):
                                                    for j in range(1, sheet31.max_column + 1):
                                                        sheet32.cell(row=i, column=j).value = sheet31.cell(row=i, column=j).value
...
def SchemaBuilding():
    Final_File = pd.concat([sales, care, sky, skyservice, vmcare, vmcablecare, LM, Verizon, phase3_gendtvsales, phase3_gendhsclg, phase3_gendhssales, phase4_dmdr, phase4_ismclg, phase4_ismsvc, phase4_mobclg, phase4_mobss, nurseline, housecalls,uhg])
...
class NewWindow(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.UHG = Button(self, text='UHG M&R', padx=10)
        self.UHG.bind('<Button>', lambda e: NewWindow1(master, 'UHG_M&R'))
        self.UHG.pack()
        self.vmtelesales = Button(self, text='VM Telesales', padx=10)
        self.vmtelesales.bind('<Button>', lambda e: NewWindow1(master, 'VM Telesales'))
        self.vmtelesales.pack()
